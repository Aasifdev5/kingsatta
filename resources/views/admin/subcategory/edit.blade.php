                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-md-4">
                           ...
                           <select name="data1" id="inputState" class="form-control">
                              ...
                              <option value="{{ $id['0'] }}" @if($id['0']==$data['cat_id']) selected @endif
                        ...
                        <div class="col-sm-4">
                           <div class="form-group">
                              ...
                              <input type="date" class="form-control" id="exampleFormControlTextarea1" name="date"
                                 value="@if (!empty($data)){{ $data->date }}@else{{ old('date') }}@endif" required>
                           </div>
                        </div>
                        <div class="col-sm-4">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="exampleFormControlTextarea1" name="number"
                                 value="@if (!empty($data)){{ $data->number }}@else{{ old('number') }}@endif" required>
                           </div>
                        </div>
                        <br>
                        <div class="col-sm-4">
