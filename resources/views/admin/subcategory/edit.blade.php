                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="time" class="form-control" id="exampleFormControlTextarea1" name="time" required  value="{{ old('time') }}">
                                ...
                                <div class="col-sm-4">
                                   <div class="form-group">
                                       ...
                                       <input type="date" class="form-control" id="exampleFormControlTextarea1"  name="date" value="@if (!empty($data)){{ $data->date }}@else{{ old('date') }}@endif" required>
                                 </div>
                                </div>
                               <div class="col-sm-4">
                                   <div class="form-group">
                                        <label for="exampleFormControlTextarea1">Number</label>
                                       <input type="text" class="form-control" id="exampleFormControlTextarea1"  name="number" value="@if (!empty($data)){{ $data->number }}@else{{ old('number') }}@endif" required>
                                 </div>
                                </div>
                      <br>
                      <div class="col-sm-4">
