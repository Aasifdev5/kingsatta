                  ...
                  <div class="table-responsive">
                     <table class="table table-striped" id="data-table">
                        ...
                        <tbody>
                           ...
                           $date = date('Y-m-d');
                           $prev_date = date('Y-m-d', strtotime($date . ' -15 day'));
                           ...
                           if ($session['login_web_59ba36addc2b2f9401580f014c7f58ea4e30989d'] == 1) {
                              ...
                              $catname = DB::select("SELECT * FROM `category` where id=" . $u->cat_id . "");
                           ...
                           <?php
                              ...
                              $catname = DB::select("SELECT * FROM `category` where id=" . $user['0'] . "");
                              $name = array_column($catname, 'name', '0');
                              $time = array_column($catname, 'time', '0');
                           ?>
                           <tr>
