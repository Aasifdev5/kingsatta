   ...
   <section id="hero" class="d-flex justify-cntent-center align-items-center">
      ...
      <script type="text/javascript">
         document.addEventListener('DOMContentLoaded', function() {
            if (!Notification) {
               alert('Desktop notifications are not available in your browser. Try using Chromium.'); // If the browser is not compatible, show an alert
               return;
            }
   ...
   <main id="main">
      ...
      <section class="why-us section-bg">
         <div class="container">
            ...
            <div class="row">
               <div class="container">
                  <div class="table-h1" style="text-align: center;">Result {{ \Carbon\Carbon::now()->format('F Y') }}</div>
      ...
      <section class="why-us section-bg">
         <div class="container mt-3">
            ...
            <div class="table-h6" style="text-align: center;">
               Get {{ \Carbon\Carbon::now()->addMonth()->format('M-Y') }} Latest Satta Chart for All Satta Companies
               @foreach ($latestNames as $index => $name)

               @endforeach <a href="#">Click Here</a>
            </div></a>
