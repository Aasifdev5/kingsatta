...
<a style="position:fixed; bottom:20px;right:8px;">&nbsp;<input style="border:#e7aa26 1px solid; background:#FBC503; color:Red; height:auto; padding:8px; font-weight:bold;" id="Refresh" name="Refresh" value="Refresh" type="submit" onclick="window.location.reload()">&nbsp;</a>
      ...
      <div class="header">
         ...
         <h3 style="color:black;">Today Super Fast Live Satta Results And Chart of June 2023 for Desawar, Desawar King, Chandi Bazar, Nashik Super, Delhi Bazar, Shrimadhopur, Shri Ganesh, Kanpur City, Faridabad, Inderlok, Ghaziabad, Goa Express, Khiladi 786 and Gali from various websites
...
<!--<div class="swal2-container swal2-bottom swal2-shown" style="overflow-y: auto;"><div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;"><div class="swal2-header"><ul class="swal2-progress-steps" style="display: none;"></ul><div class="swal2-icon swal2-error" style="display: none;"><span class="swal2-x-mark"><span class="swal2-x-mark-line-left"></span><span class="swal2-x-mark-line-right"></span></span></div><div class="swal2-icon swal2-question" style="display: none;"></div><div class="swal2-icon swal2-warning" style="display: none;"></div><div class="swal2-icon swal2-info swal2-animate-info-icon" style="display: flex;"></div><div class="swal2-icon swal2-success" style="display: none;"><div class="swal2-success-circular-line-left" style="background-color: rgb(255, 255, 255);"></div><span class="swal2-success-line-tip"></span> <span class="swal2-success-line-long"></span><div class="swal2-success-ring"></div> <div class="swal2-success-fix" style="background-color: rgb(255, 255, 255);"></div><div class="swal2-success-circular-line-right" style="background-color: rgb(255, 255, 255);"></div></div><img class="swal2-image" style="display: none;"><h2 class="swal2-title" id="swal2-title" style="display: none;"></h2><button type="button" class="swal2-close" style="display: none;" aria-label="Close this dialog">×</button></div><div class="swal2-content"><div id="swal2-content" style="display: block;">क्या आप सभी गेम्स की खबर, लीक नंबर, टिप्स, और ट्रिक्स के अपडेट चाहते है?</div><input class="swal2-input" style="display: none;"><input type="file" class="swal2-file" style="display: none;"><div class="swal2-range" style="display: none;"><input type="range"><output></output></div><select class="swal2-select" style="display: none;"></select><div class="swal2-radio" style="display: none;"></div><label for="swal2-checkbox" class="swal2-checkbox" style="display: none;"><input type="checkbox"><span class="swal2-label"></span></label><textarea class="swal2-textarea" style="display: none;"></textarea><div class="swal2-validation-message" id="swal2-validation-message"></div></div><div class="swal2-actions"><button type="button" class="swal2-confirm swal2-styled" style="display: inline-block; background-color: rgb(46, 125, 50); border-left-color: rgb(46, 125, 50); border-right-color: rgb(46, 125, 50);" onclick="notifyMe();" aria-label="">जी हाँ, जरुर</button><button type="button" class="swal2-cancel swal2-styled" style="display: inline-block; background-color: rgb(244, 67, 54);" aria-label="">नहीं, फिर कभी</button></div><div class="swal2-footer" style="display: none;"></div></div></div>-->
   <main id="main">
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="container">
                  ...
                  <div class="table-h2" style="text-align: center;">Updated:
                   <?php
                    ...
                    //  if(str_replace(array('AM','PM')," ",$subcategory->time) >= $current_time){
                        ...
                        <tr>
                           <td>{{ $subcategory->category_name }} <br>
                              <div class="table-link">at {{ $subcategory->time }} <a
                  ...
                  <table class="table table-hover" id="table-first">
                     ...
                     <tbody>
                            ...
                            ?>
                             <tr>
                                 <td>{{ $row['name'] }} <br>
                              <div class="table-link">at {{ $row['time'] }}<a
