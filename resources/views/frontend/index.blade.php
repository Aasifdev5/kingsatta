...
<body>
   ...
   <div class="swal2-container swal2-bottom swal2-shown" id="popup-form-browser" style="overflow-y: auto;">
      <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show"
         ...
         style="display: flex;margin:auto!important;">
         ...
         <div class="swal2-content">
            <div id="swal2-content" style="display: block;">क्या आप सभी गेम्स की खबर, लीक नंबर, टिप्स, और ट्रिक्स
               के अपडेट चाहते है?</div><input class="swal2-input" style="display: none;"><input type="file"
         ...
         <div class="swal2-actions"><button type="button" onclick="getBrowserID()" class="swal2-confirm swal2-styled"
               style="display: inline-block; background-color: rgb(46, 125, 50); border-left-color: rgb(46, 125, 50); border-right-color: rgb(46, 125, 50);"
               ...
               <div class="container">
                  ...
                  <table class="table table-hover">
                     ...
                     <tbody>
                        ...
                        $catId = DB::table('category')->orderBy('time', 'Asc')->take(5)->get();
